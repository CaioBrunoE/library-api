...
public class BookControllerTeste {
    ...
    @Test
    @DisplayName("Deve retorna resource not found quando não encontra um livro para deletar")
    public void deleteInessitentBooktest() throws Exception{
